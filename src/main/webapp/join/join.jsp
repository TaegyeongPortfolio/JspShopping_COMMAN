...
<body>
    ...
    <form name="joinform" action="join_ok.jsp" method="post">
        이름: <input type="text" name="name" placeholder="한글 6~12자"><br />
        아이디: <input type="text" name="id" placeholder="영문 숫자 5~11자"><br />
        비밀번호: <input type="password" name="password"><br />
        비밀번호 확인: <input type="password" name="passwordCheck" placeholder="비밀번호 재입력"><br />
        전화번호:
        <select name="phone1">
                <option>010</option>
                <option>011</option>
        ...
        <input type ="submit" value="가입" onclick="checkform()">
